...
module pipeline_hazard_tb;
    ...
    initial begin
        ...
        imem[ 1] = enc_i(3,  1, 2, 3'b000, 7'b0010011);
        imem[ 2] = enc_r(7'b0, 2, 1, 3'b000, 3);
        imem[ 3] = enc_s(0,  3, 0, 3'b010);
        imem[ 4] = enc_i(0,  0, 4, 3'b010, 7'b0000011);   // lw x4,0(x0)
        imem[ 5] = enc_i(1,  4, 5, 3'b000, 7'b0010011);
        imem[ 6] = enc_b(8,  3, 5, 3'b000);
        imem[ 7] = enc_i(2,  5, 6, 3'b000, 7'b0010011);   // addi x6,x5,2
        imem[ 8] = enc_b(8,  6, 6, 3'b000);
        imem[ 9] = enc_i(99, 0, 7, 3'b000, 7'b0010011);
        imem[10] = enc_i(42, 0, 8, 3'b000, 7'b0010011);
        imem[11] = enc_j(8,  0);                          // jal x0,+8
        imem[12] = enc_i(1,  0, 8, 3'b000, 7'b0010011);
        ...
        imem[18] = enc_i(0,  0, 13, 3'b010, 7'b0000011);
        imem[19] = enc_i(0, 10, 12, 3'b010, 7'b0000011);
